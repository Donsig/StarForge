...
const defaultActions: GameActions = {
  ...
  adminSetNPCSpecialty: (_coords, _specialty) => {},
  ...
  adminNPCTriggerUpgrade: (_coords) => {},
  adminClearNPCRaidHistory: (_coords) => {},
  adminForceAbandonNPC: (_coords) => {},
  adminSetPlanetFieldCount: (_planetIndex, _fieldCount) => {},
